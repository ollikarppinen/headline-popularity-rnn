...
plt.plot(mean_by_weekday['weekday'], mean_by_weekday['clicks'])
plt.title('Clicks by weekday')
plt.ylabel('weekday, 0 == monday')
plt.xlabel('clicks mean')
plt.savefig('./clicks_by_weekday.png')
plt.clf()
plt.plot(mean_by_hour['hour'], mean_by_hour['clicks'])
plt.title('Clicks by hour')
plt.ylabel('hour')
plt.xlabel('clicks mean')
plt.savefig('./clicks_by_hour.png')
